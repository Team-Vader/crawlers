...
def getfromsearch(query, place):
    ...
    ---------------------
    Uses the search ajax calls
    and looks through them to simply get the json data
    """
...
def crawlfromsearch(query, place):
    ...
    Uses bs4 to search and crawl the webpage.
    """
    JUSTS= []
...
for i in crawlfromsearch("hello","hyderabad"):
    ...
    -------------------------
    i is a Just object
    i.__dict__ simply gives the json object here
    """
    pprint (i.__dict__)

### Usage
print "\n\n\n Using getfromsearch method "
print getfromsearch("book","Hyderabad")
